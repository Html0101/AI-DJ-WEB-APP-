...
{ 
    if(results>0){
        ...
        rightWristScore = results.keypoints[10].score;
    }
}
...
{ 
    ...
    rightStatus = fatRat.isPlaying();

    if(rightWristScore > 0.2) 
    { 
        circle(xright, yright, 20);
        aSong.stop();
    }
    if(rightStatus == false){
        aSong.play();
        document.getElementById("songShown").innerHTML = "A Song";
    }
}